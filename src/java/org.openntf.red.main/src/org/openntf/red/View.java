 ...
 * The Interface View.
 */
public interface View extends lotus.domino.View, Base, Design, DatabaseDescendant, Externalizable, Map<String, Object> {
	 ...
	 */
	@Override
	public int FTSearchSorted(final String query, final int maxDocs, final int column, final boolean ascending,
	 ...
	 */
	@Override
	public int FTSearchSorted(final String query, final int maxDocs, final String column, final boolean ascending,
			final boolean exact, final boolean variants, final boolean fuzzy);
	...
	@Deprecated
	@Legacy({ Legacy.INTERFACES_WARNING, Legacy.GENERICS_WARNING })
	public int FTSearchSorted(final Vector query, final int maxDocs, final int column, final boolean ascending,
			final boolean exact, final boolean variants, final boolean fuzzy);
	...
	@Deprecated
	@Legacy({ Legacy.INTERFACES_WARNING, Legacy.GENERICS_WARNING })
	public int FTSearchSorted(final Vector query, final int maxDocs, final String column, final boolean ascending,
			final boolean exact, final boolean variants, final boolean fuzzy);
	 ...
	 */
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getAllDocumentsByKey(Object)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getAllDocumentsByKey(Object, boolean)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getAllEntriesByKey(Object)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getAllEntriesByKey(Object, boolean)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getFirstDocumentByKey(Object)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getFirstDocumentByKey(Object, boolean)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getFirstEntryByKey(Object)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	...
	/**
	 * @deprecated Pass generic {@link java.util.Collection}s to
	 *             {@link #getFirstEntryByKey(Object, boolean)} instead.
	 */
	@SuppressWarnings("rawtypes")
	@Override
	@Deprecated
	 ...
	 * 
	 * <p>
	 * NOTE: This doesn't take into account any searching done over the view. It
	 * also iterates the NoteIDs from the entries in the view and adds those
	 * documents to a collection. Although a convenience method, in all
	 * likelihood the recommended approach would be to use getAllEntries and
	 * then, while iterating the entries, call getDocument().
	 * </p>
	 * 
	 * <p>
	 * One use case for this is if you need to pass a DocumentCollection to a
	 * method, e.g.
	 ...
	 * 
	 * <p>
	 * NOTE: This may not be particularly performant at this time so has been
	 * deprecated.
	 * </p>
	 * 
	...
	/**
	 * Gets the XPage the view is designed to open using, on View Properties
	 * Advanced tab (beanie image)
	 * 
	 ...
	 */
	public boolean checkUnique(final Object key, final org.openntf.red.Document srcDoc);
	 ...
	 * @since org.openntf.domino 5.0.0
	 */
	public Map<String, org.openntf.red.ViewColumn> getColumnMap();

	/**
	 * Interrogates the flags in the design note to identify the index type for
	 * the View
	 * 
	 * @return IndexType for the view, e.g. IndexType.SHARED,
	 *         IndexType.SHAREDPRIVATEONSERVER
	 * @since org.openntf.domino 5.0.0
	 */
	public IndexType getIndexType();

	/**
	 * Interrogates the design note for the $FormulaTV field. This exists if a
	 * time-specific formula is included in the view, i.e. "@Today" or "@Now".
	 * This severely impacts performance and developers using this should be
	 * re-educated on better practice alternatives
	 * 
	...
	/*
	 * '/P=' + the number of hours until discarding of the view index. '/T'
	 * Discard view index after each use. '/M' Manual refresh. '/O' Automatic
	 * refresh. '/R=' + the number of seconds between automatically refresh of
	 * view. '/C' Don't show empty categories '/L' Disable auto-update
	 */

	/**
	 * Interrogates the design note's $Index field for the /L flag. This
	 * disables auto-update so users will need to manually refresh the view.
	 * This can be done via the refresh indicator in Notes Client, but a
	 * mechanism needs coding for XPages.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /C flag. This exists
	 * if "Hide empty categories" is switched on. This prevents categories being
	 * displayed if the user does not have access to any of the documents within
	 * that category.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /T flag. This exists
	 * if the index should be discarded after each use.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /M flag. This exists
	 * if the view has to be manually refreshed. This can be done via the
	 * refresh indicator in Notes Client, but a mechanism needs coding for
	 * XPages.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /O flag. This exists
	 * if the view is set to be automatically refreshed
	 * 
	...
	/**
	 * Interrogates the design note's $Index field to see if the view index is
	 * Auto after first use, the default.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /R flag and gets the
	 * integer after the equals. The existence of the flag identifies the
	 * refresh setting as "Auto, at most every". The number is the amount of
	 * seconds between automatic refreshes of the view.
	 * 
	...
	/**
	 * Interrogates the design note's $Index field for the /P flag and gets the
	 * integer after the equals. This is the number of hours before a view index
	 * is discarded.
	 * 
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getDocumentByKey(java.lang.Object) The original
	 * method is poorly named, as it doesn't indicate what happens when more
	 * than one Document matches the key.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getDocumentByKey(java.lang.Object, boolean) The
	 * original method is poorly named, as it doesn't indicate what happens when
	 * more than one Document matches the key.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getDocumentByKey(java.util.Vector) The original
	 * method is poorly named, as it doesn't indicate what happens when more
	 * than one Document matches the key.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getDocumentByKey(java.util.Vector, boolean) The
	 * original method is poorly named, as it doesn't indicate what happens when
	 * more than one Document matches the key.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getEntryByKey(java.lang.Object) The original
	 * method is poorly named, as it doesn't indicate what happens when more
	 * than one Document matches the key.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getEntryByKey(java.lang.Object, boolean) The
	 * original method is poorly named, as it doesn't indicate what happens when
	 * more than one ViewEntry matches the key.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getEntryByKey(java.util.Vector) The original
	 * method is poorly named, as it doesn't indicate what happens when more
	 * than one ViewEntry matches the key.
	 */
	@SuppressWarnings("rawtypes")
	@Legacy(Legacy.GENERICS_WARNING)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.View#getEntryByKey(java.util.Vector, boolean) The
	 * original method is poorly named, as it doesn't indicate what happens when
	 * more than one ViewEntry matches the key.
	 * 
	 */
