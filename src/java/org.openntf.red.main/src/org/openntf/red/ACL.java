 ...
 * The Interface that represents the access control list (ACL) of an IBM Domino
 * database.
 */
public interface ACL extends Base, lotus.domino.ACL, Iterable<org.openntf.red.ACLEntry>, DatabaseDescendant {
	 ...
	 *            server in the ACL. May be any of the following :<br>
	 *            <br>
	 *            <ul>
	 ...
	 *             {@link org.openntf.domino.ext.ACL#createACLEntry(String, Level)}
	 * 
	 */
	@Deprecated
	@Override
	 ...
	 * This property is an <code>empty string</code> if the database does not
	 * have an administration server.
	 * 
	 ...
	 * @return The {@link ACLEntry} that matches the name. If name is not in the
	 *         ACL, returns <code>null</code>.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * </ul>
	 * 
	 * @return The current maximum internet access level of the database. May be
	 ...
	 * <p>
	 * The no-parameter method improves performance for remote operations
	 * because ACL entries are cached locally.
	 * <p>
	 * The order of the ACL entries is unspecified. The order is not
	 * alphabetical and does not correspond to UI displays.
	 * 
	 * @return The next {@link ACLEntry} in the ACL. Returns <code>null</code>
	 ...
	 * @return The the {@link ACLEntry} following the entry specified as the
	 *         parameter. Returns <code>null</code> if there are no more
	 *         entries.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * <p>
	 * Each element in the vector is the name of a role. Each role name is
	 * surrounded by square brackets, for example, "[Supervisor]."
	 * <p>
	 * Notes Release 2 "privileges" are surrounded by parentheses. Properties
	 * and methods affecting roles, such as disableRole and enableRole, do not
	 * work on privileges.
	 * 
	 * @return A {@link java.lang.Vector Vector} of all the roles in the ACL.
	 *         Elements are of type {@link java.lang.String String}
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * <p>
	 * The database must have an administration server. See
	 * {@link #getAdministrationServer} in ACL and
	 * {@link ACLEntry#isAdminServer} in
	 * 
	 * @return Returns <code>true</code> if the administration server can modify
	 *         all names fields, <code>false</code> if it cannot.
	 ...
	 * 
	 * @return Returns <code>true</code> if the administration server can modify
	 *         Readers and Authors fields, <code>false</code> if it cannot.
	 *         {@link ACLEntry} to check for the administration server.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * <p>
	 * In the Notes UI, this property is in the advanced section of ACL
	 * properties: "Enable Extended Access." and only applies to Domino
	 * Directory, Extended Directory Catalog, and Administration Requests
	 * databases.
	 * 
	 * @return Returns <code>true</code> if extended access is enabled,
	 *         <code>false</code> if it is not enabled.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * 
	 * @return Returns <code>true</code> if uniform access is enabled,
	 *         <code>false</code> if it is not enabled.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	 ...
	 * <p>
	 * After calling this method, you must call {@link #save()} for the changes
	 * to take effect. If you do not call save, your changes to the ACL are
	 * lost.
	 * 
	 * @param name
	 ...
	 * <p>
	 * After calling this method, you must call {@link #save} for the changes to
	 * take effect. If you do not call save, your changes to the ACL are lost.
	 * <p>
	 ...
	 * <p>
	 * If you don't call save before closing a database, the changes you've made
	 * to its ACL are lost.
	 * 
	 * @since lotus.domino 4.5.0
	 */
	 ...
	 * 
	 * @param server
	 *            the name of the server you want to set as the Administration
	 *            Server.
	 * @since lotus.domino 4.5.0
	 */
	@Override
	...
	/**
	 * Sets whether the administration server for the database can modify all
	 * Names fields in a database.
	 * <p>
	 * The database must have an administration server. See
	 * {@link ACL#getAdministrationServer} in ACL and
	 * 
	 * @param flag
	 *            The boolean value to set
	 *            {@link org.openntf.domino.ACLEntry#isAdminServer()} in
	 *            {@link ACLEntry} to set the administration server.
	 *            <p>
	 *            After setting this property, you must call {@link #save} for
	 *            the changes to take effect. If you do not call save, your
	...
	/**
	 * Sets whether the administration server for the database can modify
	 * Readers and Authors fields in a database.
	 * <p>
	 * The database must have an administration server. See
	 * {@link ACL#getAdministrationServer} in ACL and
	 ...
	 * {@link #setUniformAccess(boolean)} true. Setting this property false does
	 * not automatically set {@link #setUniformAccess(boolean)} false.
	 * <p>
	 * After setting this property, you must call {@link #save} for the changes
	 * to take effect. If you do not call save, your changes to the ACL are
	 * lost.
	 * 
	 * @param flag
	 ...
	 * 
	 * @param level
	 *            The new maximum Internet level you want to set in the ACL. May
	...
	/**
	 * Sets whether a consistent access control list is enforced across all
	 * replicas of a database.
	 * 
	 * <p>
	 * After setting this property, you must call {@link #save} for the changes
	 ...
	 * 
	 * <p>
	 * This is the preferred way of adding an ACLEntry over
	 * {@link org.openntf.domino.ACL#createACLEntry(String, int)}. By using an
	 * enum rather than an int, it prevents accidentally using integers that are
	 * unsupported.
	 * </p>
	 * 
	 * @param name
	 ...
	 * @param level
	 *            The level that you want to assign to this person, group, or
	 *            server in the ACL, of type ACL.Level.
	 * 
	 * @return The newly-created {@link org.openntf.domino.ACLEntry}.
	 ...
	 * 
	 * @param level
	 *            The new maximum Internet level you want to set in the ACL, of
	 *            type ACL.Level.
