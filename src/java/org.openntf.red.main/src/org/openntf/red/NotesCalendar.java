 ...
 */
public interface NotesCalendar extends Base, lotus.domino.NotesCalendar, SessionDescendant {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.NotesCalendar#getEntries(lotus.domino.DateTime,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.NotesCalendar#getNewInvitations(lotus.domino.DateTime,
	 * lotus.domino.DateTime)
	 */
	@Override
	public Vector<NotesCalendarNotice> getNewInvitations(final lotus.domino.DateTime start,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.NotesCalendar#readRange(lotus.domino.DateTime,
	 * lotus.domino.DateTime)
	 */
	@Override
	 ...
	 */
	@Override
	public String readRange(final lotus.domino.DateTime start, final lotus.domino.DateTime end, final int skipCount,
			final int maxRead);
