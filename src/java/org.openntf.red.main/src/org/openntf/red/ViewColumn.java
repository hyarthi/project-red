 ...
 */
public interface ViewColumn extends Base, lotus.domino.ViewColumn, Design, DatabaseDescendant {
	...
	/**
	 * Returns the column's true index. Unlike the core Domino method (
	 * {@link lotus.domino.ViewColumn#getColumnValuesIndex()}) this does not
	...
	/**
	 * Returns the columnValueIndex of this column if you want to read the value
	 * from an entry.
	 * 
	 * @param correctValue
	 *            if false, the uncorrected value of the delegete is returned,
	 *            i.e. columns containing constants are ignored.<br/>
	 *            If true, getIndex is called (This is needed for
