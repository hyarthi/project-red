 ...
 */
public interface ViewNavigator extends Base, lotus.domino.ViewNavigator, Iterable<ViewEntry>, DatabaseDescendant {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.ViewNavigator#setAutoExpandGuidance(int,
	 * lotus.domino.NoteCollection, lotus.domino.NoteCollection)
	 */
	@Override
