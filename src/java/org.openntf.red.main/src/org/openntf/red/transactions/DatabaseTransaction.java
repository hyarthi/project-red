 ...
 *
 */
public class DatabaseTransaction implements IDatabaseTransaction {
	...
	public DatabaseTransaction(final org.openntf.red.Database database) {
	...
	public void commit() {
		...
		while (next != null) {
			if (next instanceof org.openntf.red.Document) {
				org.openntf.red.Document doc = (org.openntf.red.Document) next;
				if (isDocLock(doc))
					doc.unlock();
