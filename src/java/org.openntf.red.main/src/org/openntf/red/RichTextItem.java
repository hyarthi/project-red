 ...
 */
public interface RichTextItem extends lotus.domino.RichTextItem, org.openntf.red.Item, DocumentDescendant {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.RichTextItem#addPageBreak(lotus.domino.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.RichTextItem#appendParagraphStyle(lotus.domino.
	 * RichTextParagraphStyle)
	 */
	@Override
	...
	@SuppressWarnings("rawtypes")
	@Override
	public void appendTable(final int rows, final int columns, final Vector labels, final int leftMargin,
			final Vector pstyles);
	 ...
	 * 
	 * @see lotus.domino.RichTextItem#beginSection(java.lang.String,
	 * lotus.domino.RichTextStyle, lotus.domino.ColorObject, boolean)
	 */
	@Override
	public void beginSection(final String title, final lotus.domino.RichTextStyle titleStyle,
			final lotus.domino.ColorObject barColor, final boolean expand);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see lotus.domino.RichTextItem#embedObject(int, java.lang.String,
	 * java.lang.String, java.lang.String)
	 */
	@Override
