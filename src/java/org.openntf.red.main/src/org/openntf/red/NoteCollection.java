 ...
 */
public interface NoteCollection extends Base, lotus.domino.NoteCollection, Iterable<String>, DatabaseDescendant {
	...
	public static enum SelectOption {
		ACL, ACTIONS, AGENTS, DATABASE_SCRIPT, DATA_CONNECTIONS, DOCUMENTS, FOLDERS, FORMS, FRAMESETS, HELP_ABOUT, HELP_INDEX, HELP_USING, ICON, IMAGE_RESOURCES, JAVA_RESOURCES, MISC_CODE, MISC_FORMAT, MISC_INDEX, NAVIGATORS, OUTLINES, PAGES, PROFILES, REPLICATION_FORMULAS, SCRIPT_LIBRARIES, SHARED_FIELDS, STYLESHEETS, SUBFORMS, VIEWS, ALL_BUT_NOT;
	}
	 ...
	 * 
	 * @see
	 * lotus.domino.NoteCollection#intersect(lotus.domino.DocumentCollection)
	 */
	@Override
	...
	/**
	 * Checks whether a collection is the same object as another. There is not
	 * currently any specific implementation overriding standard Java
	 * functionality. This will not return true if two different NoteCollections
	 * containt the same notes, just if they are the same Java object.
	 * 
	...
	/**
	 * Loads a set of SelectOption enums to be used for creating the collection.
	 * This is the preferred method over using the specific setters, to ensure
	 * easy access to all valid options.
	 * 
	 * @param options
	 *            Set<SelectOption> enum values corresponding to desired note
	 *            types
	 * @since org.openntf.domino 2.5.0
	 */
	...
	/**
	 * Setter to allow easy setting of the last modified date since when to
	 * retrieve notes
	 * 
	 * @param since
	 *            Date since when notes should have been modified to load into
	 *            collection
