...
Comparable<Name>, Cloneable {
	 ...
	 * @param parent
	 */
	protected Name(lotus.domino.Name delegate, Session parent) {
	 ...
	 * @param lang
	 */
	protected Name(Session parent, String name, String lang) {
	 ...
	 * @param parent
	 */
	protected Name(NamePartsMap namePartsMap, boolean hierarchical, Session parent) {
		super(null, parent, NOTES_NAME);
		// TODO Auto-generated constructor stub
	}
